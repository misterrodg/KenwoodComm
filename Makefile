...
# Source files
SRC_FILES = $(SRC_DIR)/main.cpp $(SRC_DIR)/command.cpp $(SRC_DIR)/commandset.cpp $(SRC_DIR)/defaults.cpp $(SRC_DIR)/fn.cpp $(SRC_DIR)/helpers.cpp $(SRC_DIR)/session.cpp $(SRC_DIR)/vfo.cpp
