...
# Source files
SRC_FILES = $(SRC_DIR)/main.cpp $(SRC_DIR)/command.cpp $(SRC_DIR)/command_dispatcher.cpp $(SRC_DIR)/commandset.cpp $(SRC_DIR)/defaults.cpp $(SRC_DIR)/helpers.cpp $(SRC_DIR)/response.cpp $(SRC_DIR)/serial.cpp $(SRC_DIR)/session.cpp
