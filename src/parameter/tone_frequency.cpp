...
ToneFrequency::StringToToneFrequency(const std::string& toneString) {
    static const std::map<std::string, ToneFrequency::ToneFrequencyEnum>
        enumMap = {
            ...
            {"39", ToneFrequency::ToneFrequencyEnum::TN39},
...
std::string
ToneFrequency::ToneFrequencyToIntString(const ToneFrequencyEnum& toneEnum) {
    char result[3];
...
std::string
ToneFrequency::ToneFrequencyToFreqString(const ToneFrequencyEnum& toneEnum) {
    static const std::map<ToneFrequency::ToneFrequencyEnum, std::string>
        enumMap = {
...
std::string ToneFrequency::ToneFrequencyToFriendlyString(
    const ToneFrequencyEnum& toneEnum) {
    std::string frequency = ToneFrequencyToFreqString(toneEnum);
